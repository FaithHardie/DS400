...
This prediction is unceetain, there is a wide margin between the lowest prediction of rides and highest rides. From a business standpoint, this isn't the certainty I'd want.

Instead, i would want to use the other variables from the bike dataset to get the best possible model to have more certainty. For example, including the date, windspeed, month, holiday.

If my boss asked specifically, what is the relationship between temperature and rides, then I would use this gaussian model.
