...
```{r}
naive_model_2 <- naiveBayes(climate_change ~ science_is_honest + party + vaccines_are_safe, data = pulse_of_the_nation)

```

```{r}
our_person <- data.frame(science_is_honest = "Strongly Disagree", party= "republican", vaccines_are_safe = "Strongly Disagree")
```
