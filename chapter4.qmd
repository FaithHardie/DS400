...
1.  All prior choices are informative.
    ...
    1.   No, some prior choices are not informative, for example a alpha and beta of 1,1. Meaning, there is no prior belief, and therefor the posterior will not be effected.

2.  There may be good reasons for having an informative prior.

    1.   Yes, for example if you're working with population data and your dataset is skewed 30/60 male female, having prior knowledge of the actual population size will help the posterior outcome to be more accurate, or help you take it with a grain of salt.
...
4.  The frequentist paradigm is totally objective.
    ...
    1.  No it is not totally objective, because you still have to choose sampling methods, fixed p values, etc, theres still subjective decision making that goes into frequentist stats.
...
-   somewhat favoring π\<0.5 2

-   strongly favoring π\<0.5 5

-   centering π on 0.5 1

-   somewhat favoring π\>0.5 4

-   strongly favoring π\>0.5 3
